...
/**
 * Response DTO for the general metadata endpoint.
 * Contains all metadata without a specific collection:
 * tags, people, cameras, lenses, film types, film formats, and collections.
 */
@Data
@NoArgsConstructor
@AllArgsConstructor
