...
/**
 * Model representing a film stock type for API responses. Contains the film type's ID, technical
 * name, display name, default ISO, and related image content block IDs.
 */
public record ContentFilmTypeModel(
  ...
  /** Null-safe: contentImageIds is always a list, never null. */
  public ContentFilmTypeModel {
