 ...
 * updates.
 *
 * <p>- prev: List of existing person IDs to keep/add - newValue: List of new person names to create
 * and add - remove: List of person IDs to remove
 *
 * <p>Examples: - {prev: [5, 6]} = Add existing people 5 and 6 - {newValue: ["John Doe"]} = Create
 * and add new person - {remove: [3]} = Remove person ID 3 - {prev: [5], newValue: ["Jane"], remove:
 * [3]} = All operations at once
 */
@Data
@Builder
@NoArgsConstructor
