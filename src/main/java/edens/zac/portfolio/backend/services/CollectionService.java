...
/**
 * Service interface for managing Collection entities. Provides methods for CRUD operations,
 * pagination, and client gallery access.
 */
public interface CollectionService {
  ...
  /**
   * Find visible collections by type ordered by collection date (newest first). Returns all visible
   * collections of the specified type as CollectionModel objects.
   *
   * @param type The collection type
   ...
   * associations), but does NOT delete the content itself as content is reusable.
   *
  ...
  /**
   * Get all collections ordered by collection date descending. Returns all collections regardless
   * of visibility or other filters. Intended for admin/dev use only.
   *
   ...
   * all available tags, people, cameras, and film metadata. This provides everything needed for the
   * image management UI in a single call.
   *
   ...
   *
   * @return General metadata including tags, people, cameras, lenses, film types, film formats, and
   *     collections
   */
