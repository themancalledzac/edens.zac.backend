...
public class ContentImageUpdateValidator {
  ...
  /**
   * Validate that filmFormat is provided when isFilm is true. This is a helper method for
   * validation during entity updates.
   *
   ...
   * @throws IllegalArgumentException if validation fails
   */
  public void validateFilmFormatRequired(
      Boolean isFilm, FilmFormat filmFormat, FilmFormat entityFilmFormat) {
