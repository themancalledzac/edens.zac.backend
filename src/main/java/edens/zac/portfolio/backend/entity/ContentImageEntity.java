...
/**
 * Entity representing image content. Extends ContentEntity (JOINED inheritance - base table:
 * content, child table: content_image).
 *
 * <p>Database table: content_image Primary key: id (inherited from content table, FK to content.id)
 *
 * <p>Foreign keys: - lens_id -> content_lenses.id - film_type_id -> content_film_types.id -
