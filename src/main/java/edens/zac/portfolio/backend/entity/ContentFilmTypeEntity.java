...
/**
 * Entity representing a film stock type. Film types can be associated with ContentImages via
 * foreign key relationship. This replaces the static FilmType enum to allow dynamic film type
 * management.
 *
 * <p>Database table: content_film_types Indexes: - idx_content_film_type_name (film_type_name,
 * unique)
 */
@Data
@NoArgsConstructor
