...
/**
 * Enum representing different film stock types with their default ISO values.
 * Used for categorizing film photography images.
 */
@Slf4j
public enum FilmType {
    ...
    @NotNull
    @Getter
    private final Integer defaultIso;
