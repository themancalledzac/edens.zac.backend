...
/**
 * DAO for ContentGifEntity using raw SQL queries.
 * Handles JOINED inheritance pattern (content + content_gif).
 */
@Component
@Slf4j
public class ContentGifDao extends BaseDao {
    ...
    /**
     * Save ContentGifEntity.
     * Inserts into content first, then content_gif using the same ID.
     */
    @Transactional
