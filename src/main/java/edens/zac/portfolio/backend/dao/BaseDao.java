...
/**
 * Base DAO utility class providing common JDBC operations.
 * All entity-specific DAOs should extend this class.
 * Uses NamedParameterJdbcTemplate for safer parameter binding.
 */
@Slf4j
abstract class BaseDao {
     ...
     */
    protected <T> Optional<T> queryForObject(String sql, RowMapper<T> rowMapper, SqlParameterSource paramSource) {
        try {
     ...
     * @return Optional containing the entity if found
     */
    protected <T> Optional<T> queryForObject(String sql, RowMapper<T> rowMapper, Map<String, Object> params) {
        try {
     ...
     * @return Generated ID
     */
    protected Long insertAndReturnId(String sql, String idColumnName, SqlParameterSource paramSource) {
     ...
     */
    protected static LocalDateTime getLocalDateTime(ResultSet rs, String columnName) throws SQLException {
