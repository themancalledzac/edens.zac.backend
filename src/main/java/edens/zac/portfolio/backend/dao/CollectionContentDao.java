...
public class CollectionContentDao extends BaseDao {
  ...
  @Transactional(readOnly = true)
  public List<CollectionContentEntity> findByCollectionId(
  ...
  @Transactional(readOnly = true)
  public List<CollectionContentEntity> findByCollectionIdAndContentType(
  ...
  public void updateOrderIndex(Long id, Integer orderIndex) {
    ...
    MapSqlParameterSource params = createParameterSource().addValue("orderIndex", orderIndex).addValue("id", id);
    update(sql, params);
  }
  ...
  public void updateVisible(Long id, Boolean visible) {
    ...
    MapSqlParameterSource params = createParameterSource().addValue("visible", visible).addValue("id", id);
    update(sql, params);
  }

  @Transactional
  public int shiftOrderIndices(
  ...
  @Transactional(readOnly = true)
  public Optional<CollectionContentEntity> findByCollectionIdAndOrderIndex(
  ...
  @Transactional(readOnly = true)
  public Optional<CollectionContentEntity> findByCollectionIdAndContentId(
  ...
  /**
   * Batch update order indexes for multiple content items in a single SQL
   * statement. Uses a CASE
   * statement to update all items in one query instead of N separate UPDATE
   * statements.
   *
   ...
   */
  @Transactional
  public int batchUpdateOrderIndexes(
      Long collectionId, java.util.Map<Long, Integer> contentIdToOrderIndex) {
