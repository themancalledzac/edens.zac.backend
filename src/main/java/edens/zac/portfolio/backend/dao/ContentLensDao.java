...
public class ContentLensDao extends BaseDao {
    ...
    public ContentLensEntity save(ContentLensEntity entity) {
        if (entity.getId() == null) {
            String sql = "INSERT INTO content_lenses (lens_name, created_at) VALUES (:lensName, :createdAt)";
            ...
            String sql = "UPDATE content_lenses SET lens_name = :lensName WHERE id = :id";
            MapSqlParameterSource params = createParameterSource()
                .addValue("lensName", entity.getLensName())
