 ...
 * Handles JOINED inheritance pattern (content + content_image, content_text,
 * etc.).
...
public class ContentDao extends BaseDao {
    ...
    private static final RowMapper<ContentImageEntity> CONTENT_IMAGE_ROW_MAPPER = (rs, rowNum) -> {
        ContentImageEntity entity = ContentImageEntity.builder()
                ...
                .filmFormat(rs.getString("film_format") != null
                        ? edens.zac.portfolio.backend.types.FilmFormat.valueOf(rs.getString("film_format"))
                        : null)
        ...
        if (cameraId != null) {
            entity.setCamera(edens.zac.portfolio.backend.entity.ContentCameraEntity.builder()
                    .id(cameraId)
        ...
        if (lensId != null) {
            entity.setLens(edens.zac.portfolio.backend.entity.ContentLensEntity.builder()
                    .id(lensId)
        ...
        if (filmTypeId != null) {
            entity.setFilmType(edens.zac.portfolio.backend.entity.ContentFilmTypeEntity.builder()
                    .id(filmTypeId)
     ...
     * Returns ContentImageEntity, ContentTextEntity, ContentGifEntity, or
    ...
    public List<ContentEntity> findAllByIds(List<Long> ids) {
        ...
        if (idsByType.containsKey(ContentType.COLLECTION)) {
            ...
            MapSqlParameterSource params = createParameterSource().addValue("ids",
                    idsByType.get(ContentType.COLLECTION));
    ...
    public Optional<ContentCollectionEntity> findContentCollectionByReferencedCollectionId(
        ...
        MapSqlParameterSource params = createParameterSource().addValue("referencedCollectionId",
