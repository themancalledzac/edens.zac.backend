  ...
  class CollectionRoles {
    ...
    void returnsGrantingRolesAsRows() throws Exception {
      when(roleRepository.rolesGrantingCollection(42L))
          .thenReturn(
              List.of(
                  new CollectionRoleGrant(7L, "family gallery", AccessLevel.CLIENT, null, null),
                  new CollectionRoleGrant(9L, "mara crew", AccessLevel.GENERAL, null, null)));
      ...
      mockMvc
          ...
          .andExpect(jsonPath("$[1].name").value("mara crew"))
          ...
          .thenReturn(
              List.of(
                  new CollectionRoleGrant(
                      7L, "pnwer crew", AccessLevel.CLIENT, 12L, "PNWER Parent")));
