...
class ContentControllerDevTest {
        ...
        void updateImages_shouldUpdateImagesWithCameraLensFilmType() throws Exception {
                ...
                ContentImageUpdateRequest.CameraUpdate cameraUpdate = ContentImageUpdateRequest.CameraUpdate.builder()
                                .newValue("Canon AE-1").build();

                ContentImageUpdateRequest.LensUpdate lensUpdate = ContentImageUpdateRequest.LensUpdate.builder()
                                .newValue("50mm f/1.8").build();

                ContentImageUpdateRequest.FilmTypeUpdate filmTypeUpdate = ContentImageUpdateRequest.FilmTypeUpdate
                                .builder()
        ...
        void updateImages_shouldUpdateImagesWithAllMetadata() throws Exception {
                // Arrange
                CollectionRequests.TagUpdate tagUpdate = new CollectionRequests.TagUpdate(List.of(1L),
                                List.of("travel"), List.of());

                CollectionRequests.PersonUpdate personUpdate = new CollectionRequests.PersonUpdate(List.of(5L),
                                List.of("Alice"), List.of());

                ContentImageUpdateRequest.CameraUpdate cameraUpdate = ContentImageUpdateRequest.CameraUpdate.builder()
                                .newValue("Nikon F3").build();

                ContentImageUpdateRequest.LensUpdate lensUpdate = ContentImageUpdateRequest.LensUpdate.builder()
                                .newValue("85mm f/1.4").build();
        ...
        void updateImages_shouldHandleInvalidRequest() throws Exception {
                // Arrange
                ContentImageUpdateRequest updateRequest = ContentImageUpdateRequest.builder().id(999L)
                                .title("Non-existent Image").build();
        ...
        void updateImages_shouldHandleGeneralErrors() throws Exception {
                // Arrange
                ContentImageUpdateRequest updateRequest = ContentImageUpdateRequest.builder().id(1L).title("Test Image")
                                .build();
        ...
        void getAllImages_shouldReturnAllImages() throws Exception {
                ...
                org.springframework.data.domain.Pageable pageable = org.springframework.data.domain.PageRequest.of(0,
                                50);
                org.springframework.data.domain.Page<ContentImageModel> page = new org.springframework.data.domain.PageImpl<>(
                                testImages, pageable, testImages.size());
