...
class GifContentBlockModelTest {

    private Validator validator;
    private GifContentBlockModel gifContentBlock;

    @BeforeEach
    void setUp() {
        ValidatorFactory factory = Validation.buildDefaultValidatorFactory();
        validator = factory.getValidator();
        gifContentBlock = new GifContentBlockModel();
    }
    ...
    void validGifContentBlockModel_shouldPassValidation() {
        ...
        gifContentBlock.setBlockType(ContentBlockType.GIF);
        ...
        // Act
        Set<ConstraintViolation<GifContentBlockModel>> violations = validator.validate(gifContentBlock);
    ...
    void nullGifUrl_shouldFailValidation() {
        ...
        ConstraintViolation<GifContentBlockModel> violation = violations.iterator().next();
    ...
    void lombokInheritance_worksCorrectly() {
        // Arrange
        GifContentBlockModel block1 = new GifContentBlockModel();
        block1.setId(1L);
        block1.setCollectionId(1L);
        block1.setOrderIndex(0);
        block1.setBlockType(ContentBlockType.GIF);
        block1.setGifUrl("https://example.com/gif.gif");
        block1.setTitle("Test GIF");

        GifContentBlockModel block2 = new GifContentBlockModel();
        block2.setId(1L);
        block2.setCollectionId(1L);
        block2.setOrderIndex(0);
        block2.setBlockType(ContentBlockType.GIF);
    ...
    void multipleValidationErrors_areCaptured() {
        ...
        gifContentBlock.setBlockType(null); // Error 3 - inherited
