...
class TextContentBlockModelTest {

    private Validator validator;
    private TextContentBlockModel textContentBlock;

    @BeforeEach
    void setUp() {
        ValidatorFactory factory = Validation.buildDefaultValidatorFactory();
        validator = factory.getValidator();
        textContentBlock = new TextContentBlockModel();
    }
    ...
    void validTextContentBlockModel_shouldPassValidation() {
        ...
        textContentBlock.setBlockType(ContentBlockType.TEXT);
        ...
        // Act
        Set<ConstraintViolation<TextContentBlockModel>> violations = validator.validate(textContentBlock);
    ...
    void blankContent_shouldFailValidation() {
        ...
        ConstraintViolation<TextContentBlockModel> violation = violations.iterator().next();
    ...
    void lombokInheritance_worksCorrectly() {
        // Arrange
        TextContentBlockModel block1 = new TextContentBlockModel();
        block1.setId(1L);
        ...
        TextContentBlockModel block2 = new TextContentBlockModel();
        block2.setId(1L);
    ...
    void multipleValidationErrors_areCaptured() {
        ...
        textContentBlock.setBlockType(null); // Error 3 - inherited
