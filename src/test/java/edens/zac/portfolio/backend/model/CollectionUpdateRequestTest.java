...
/**
 * Unit tests for CollectionUpdateRequest
 * Tests partial update validation, password handling, and relationship updates using prev/new/remove pattern
 */
class CollectionUpdateRequestTest {
    ...
    class TagUpdateTests {
        ...
        void shouldAcceptTagUpdatesWithNewValue() {
            TagUpdate tagUpdate = TagUpdate.builder()
                    .newValue(Arrays.asList("landscape", "nature", "photography"))
                    .build();
    ...
    class PersonUpdateTests {
        ...
        void shouldAcceptPersonUpdatesWithNewValue() {
            PersonUpdate personUpdate = PersonUpdate.builder()
                    .newValue(Arrays.asList("John Doe", "Jane Smith"))
                    .build();
    ...
    class CollectionUpdateTests {
        ...
        void shouldAcceptCollectionUpdatesWithPrev() {
            ChildCollection childCollection = ChildCollection.builder()
                    .collectionId(10L)
                    .visible(true)
                    .orderIndex(0)
                    .build();
            ...
            CollectionUpdate collectionUpdate = CollectionUpdate.builder()
                    .prev(Arrays.asList(childCollection))
                    .build();
        ...
        void shouldAcceptCollectionUpdatesWithNewValue() {
            ChildCollection childCollection1 = ChildCollection.builder()
                    .collectionId(20L)
                    .visible(true)
                    .orderIndex(5)
                    .build();

            ChildCollection childCollection2 = ChildCollection.builder()
                    .collectionId(21L)
                    .visible(false)
                    .orderIndex(10)
                    .build();
        ...
        void shouldAcceptCollectionUpdatesWithAllPatterns() {
            ChildCollection prevCollection = ChildCollection.builder()
                    .collectionId(1L)
                    .visible(true)
                    .orderIndex(0)
                    .build();

            ChildCollection newCollection = ChildCollection.builder()
                    .collectionId(2L)
                    .visible(true)
                    .orderIndex(5)
                    .build();
    ...
    class ValidationTests {
        ...
        void shouldValidateTitleLengthConstraints() {
            // Too short
            CollectionUpdateRequest shortDto = CollectionUpdateRequest.builder()
                    .id(1L)
                    .title("AB")
                    .build();
            ...
            CollectionUpdateRequest longDto = CollectionUpdateRequest.builder()
                    .id(1L)
                    .title(longTitle)
                    .build();
