...
class CodeContentModelTest {

    private Validator validator;
    private CodeContentModel codeContentBlock;

    @BeforeEach
    void setUp() {
        ValidatorFactory factory = Validation.buildDefaultValidatorFactory();
        validator = factory.getValidator();
        codeContentBlock = new CodeContentModel();
    }
    ...
    void validCodeContentBlockModel_shouldPassValidation() {
        ...
        codeContentBlock.setContentType(ContentType.CODE);
        ...
        // Act
        Set<ConstraintViolation<CodeContentModel>> violations = validator.validate(codeContentBlock);
    ...
    void blankCode_shouldFailValidation() {
        ...
        ConstraintViolation<CodeContentModel> violation = violations.iterator().next();
    ...
    void multipleValidationErrors_areCaptured() {
        ...
        codeContentBlock.setContentType(null); // Error 3 - inherited
