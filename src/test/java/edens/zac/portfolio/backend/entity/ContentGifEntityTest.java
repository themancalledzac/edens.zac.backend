...
class ContentGifEntityTest {
  ...
  void testInvalidContentGifMissingRequiredField() {
    ...
    assertTrue(violations.stream().anyMatch(v -> v.getPropertyPath().toString().equals("gifUrl")));
  }
  ...
  void testOptionalFields() {
    ...
    ContentGifEntity minimalGifBlock =
        ContentGifEntity.builder()
            .contentType(ContentType.GIF)
