...
class CollectionEntityTest {
  ...
  void testTitleLengthValidation() {
    ...
    assertTrue(
        shortViolations.stream().anyMatch(v -> v.getPropertyPath().toString().equals("title")));
    ...
    assertTrue(
        longViolations.stream().anyMatch(v -> v.getPropertyPath().toString().equals("title")));
  }
  ...
  void testSlugLengthValidation() {
    ...
    assertFalse(shortViolations.isEmpty());
    assertTrue(
        shortViolations.stream().anyMatch(v -> v.getPropertyPath().toString().equals("slug")));
    ...
    assertFalse(longViolations.isEmpty());
    assertTrue(
        longViolations.stream().anyMatch(v -> v.getPropertyPath().toString().equals("slug")));
  }
  ...
  void testLocationLengthValidation() {
    ...
    assertFalse(violations.isEmpty());
    assertTrue(
        violations.stream().anyMatch(v -> v.getPropertyPath().toString().equals("location")));
  }
