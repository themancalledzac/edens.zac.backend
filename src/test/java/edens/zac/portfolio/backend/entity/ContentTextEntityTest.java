...
class ContentTextEntityTest {
  ...
  void testInvalidTextContentMissingRequiredField() {
    ...
    assertTrue(
        violations.stream().anyMatch(v -> v.getPropertyPath().toString().equals("textContent")));
  }
  ...
  void testBuilderWithAllFields() {
    ...
    assertEquals(ContentType.TEXT, textBlock.getContentType());
    assertEquals(
        "This is a sample text content with enough characters to be meaningful.",
        textBlock.getTextContent());
  ...
  void testFormatTypeValues() {
    ...
    ContentTextEntity markdownBlock =
        ContentTextEntity.builder()
            .contentType(ContentType.TEXT)
